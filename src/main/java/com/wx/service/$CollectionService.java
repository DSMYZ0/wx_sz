...
public class $CollectionService {
    ...
    @Transactional
    public List<$Collection> queryCollectionByUserIdAndItemId(Integer userId,Integer itemId){
        return collectionMapper.queryCollectionByUserIdAndItemId(userId,itemId);
    }
